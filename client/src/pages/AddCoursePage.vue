<template>
  <br /><br /><br /><br /><br />
  <div
    class="text-4xl font-bold mb-8 bg-black from-black to-black p-4 w-full fixed top-0"
  ></div>
  <form
    class="flex flex-col items-center justify-center h-screen bg-black text-black"
  >
    <div
      class="container bg-gradient-to-b from-gray-900 to-gray-600 p-8 rounded-lg shadow-md"
    >
      <center>
        <div class="text-4xl font-bold mb-8 text-white">Add a new course</div>
      </center>
      ...
      <center>
        <button
          class="w-32 h-12 bg-green-600 rounded-xl text-xl font-normal text-white"
        >
          Add
        </button>
      </center>
